...
\begin{document}
    ...
    \begin{abstract}  A reference for this material is Hubbard, J. H., \& Hubbard, B. B. (2015). Vector calculus, linear algebra, and differential forms: a unified approach (pp. 818-pages). Matrix Editions.  \end{abstract}
    \maketitle

We begin by reviewing some calculus concepts. 
...
\begin{proposition}[Classical derivative rules]
...
\begin{theorem}[$C^1$ implies differentiable]
    Let $U \subset \mathbb{R}^n$ be an open set. If  $f \in C^1( U ; \mathbb{R}^m ) $, then $f$ is differentiable at $p$ for all $p \in U$. Moreover, the differential of $f$ at $p$ is unique and given by
    \[     d_p f  : = \begin{pmatrix}
...
\begin{theorem}[Chain rule]
    Let $U \subset \mathbb{R}^n$ and $V \subset \mathbb{R}^m$ be open sets, $f \in C^{k}(U;\mathbb{R}^m)$, $h \in C^{k}(V; \mathbb{R}^{\ell})$, and $f(U) \subset V$. Then $h \circ f \in C^k (U; \mathbb{R}^{\ell})$, and for each $p \in U$, the differential is given by
