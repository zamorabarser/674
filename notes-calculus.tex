...
\begin{definition}[Differential of a function]\label{def:differential-classic}
    Let $U \subset \mathbb{R}^n$ be an open set, $f : U \to \mathbb{R}^m $ a function, and $p \in U$. We say a linear function $L : \mathbb{R}^n \to \mathbb{R} ^m  $ is a \emph{derivative} or \emph{differential} of $f$ at $p$ if 
