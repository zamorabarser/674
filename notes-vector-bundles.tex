...
\begin{definition}
    Let $E,F \to M$ be two vector bundles. A \emph{morphism} between $E$ and $F$ is a smooth map $\varphi : E \to F $ with $\pi \circ \varphi  = \pi $, and such that $\varphi : E_x \to F_x$ is a linear map for each $x \in M$.     
