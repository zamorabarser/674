...
\begin{align*}
          ...
          & = (f \circ \varphi ) \sum _{\sigma \in S_n} \text{sign}(\sigma)\, \frac{\partial y ^{ 1}}{\partial x ^{\sigma (1) }} \cdots \frac{\partial y ^{n}}{\partial x ^{\sigma (n) }}   dx^1 \wedge \cdots \wedge dx ^n  \\
