...
\[     \omega =   dy^a .     \]
Then 
\[     f^{\ast} \omega =  f^{\ast} dy^a =     \sum_{i  = 1 } ^n \frac{\partial y ^a}{\partial x ^i}  d x ^i.                  \]
We compute
\[      df ^{\ast} \omega = \sum _{i,j = 1}^n \frac{\partial ^2 y ^a}{\partial x^i \partial x ^j }  dx^i \wedge dx^j .                    \]
